return {
  {
    ...
    keys = {
      ...
      { "<M-B>", "<Esc>vb", mode = "i", desc = "Emacs: select word back" },
      { "<M-F>", "<Esc>ve", mode = "i", desc = "Emacs: select word forward" },
      { "<M-B>", "b", mode = "x", desc = "Emacs: extend selection back" },
      { "<M-F>", "e", mode = "x", desc = "Emacs: extend selection forward" },
